...
srun --ntasks="${SLURM_NNODES:-1}" --ntasks-per-node=1 --cpus-per-task="${SLURM_CPUS_PER_TASK:-16}" env SPAR7M_SKIP_FINAL_PACKAGING=1 /scratch/indrisch/Structured3D/scripts/format_SPAR-7M-RGBD_multinode.sh
